  ...
  return (
    <footer className="bg-luxury-black border-t border-luxury-border pt-16 pb-8 px-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3 bg-white/5 border border-luxury-border rounded-xl flex flex-col items-center justify-center gap-2">
              <span className="text-[10px] font-bold text-white/60">ISO 27001</span>
              <div className="w-6 h-1 bg-gold/30 rounded-full" />
            </div>
            <div className="p-3 bg-white/5 border border-luxury-border rounded-xl flex flex-col items-center justify-center gap-2">
              <span className="text-[10px] font-bold text-white/60">PIPEDA</span>
              <div className="w-6 h-1 bg-gold/30 rounded-full" />
            </div>
            <div className="p-3 bg-white/5 border border-luxury-border rounded-xl flex flex-col items-center justify-center gap-2">
              <span className="text-[10px] font-bold text-white/60">CASL</span>
              <div className="w-6 h-1 bg-gold/30 rounded-full" />
            </div>
            <div className="p-3 bg-white/5 border border-luxury-border rounded-xl flex flex-col items-center justify-center gap-2">
              <span className="text-[10px] font-bold text-white/60">GDPR</span>
              <div className="w-6 h-1 bg-gold/30 rounded-full" />
            </div>
          </div>
        </div>
      ...
      <div className="mt-8 text-center">
        <p className="text-[9px] text-white/20 max-w-3xl mx-auto leading-relaxed italic">
...
const FooterLink = ({ label }: { label: string }) => (
  <li>
    <a href="#" className="text-xs text-white/40 hover:text-gold transition-colors flex items-center gap-2 group">
      {label}
